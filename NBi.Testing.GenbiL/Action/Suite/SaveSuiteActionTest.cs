...
namespace NBi.Testing.GenbiL.Action.Suite
{
    ...
    public class SaveSuiteActionTest
    {
        ...
        public void Execute_CsvProfile_Saved(string emptyCell, string missingCell, char fieldSeparator, string recordSeparator, char textQualifier, bool firstRowHeader)
        {
