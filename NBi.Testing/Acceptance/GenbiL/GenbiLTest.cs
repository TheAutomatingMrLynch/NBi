...
namespace NBi.Testing.Acceptance.GenbiL
{
    ...
    public class GenbiLTest
    {
        ...
        public void Run_SimpleTestSuiteBuild_FileIsCorrect()
        {
            ...
            Assert.That(content, Is.Not.Contain("caption=\"exclude-dimension\""));
            ...
            Assert.That(content, Does.Contain("<connectionString>youyou-default-assert</connectionString>"));

            Assert.That(content, Does.Contain("<default"));
            Assert.That(content, Does.Contain("apply-to=\"system-under-test\""));
            Assert.That(content, Does.Contain("<connectionString>youyou-default-sut</connectionString>"));
            ...
            Assert.That(content, Does.Contain("<connectionString>youyou-reference-noway</connectionString>"));
