...
namespace NBi.Testing.Acceptance.GenbiL
{
    ...
    public class SettingsTest
    {
        ...
        public void Run_SimpleTestSuiteBuild_FileIsCorrect()
        {
            ...
            Assert.That(content, Does.Contain("<connectionString>myDefaultConnectionString</connectionString>"));

            Assert.That(content, Does.Contain("<reference"));
            Assert.That(content, Does.Contain("name=\"olap\""));
            Assert.That(content, Does.Contain("<connectionString>myReferenceConnectionString</connectionString>"));
